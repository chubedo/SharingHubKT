...
export default function Input({
  ...
  const Element = typeElement === 'textarea' ? 'textarea' : 'input'
  return (
    <div className={classNameWrapper}>
      <div className='relative'>
        ...
        <label
          htmlFor={id}
          className={`absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-[5] origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 ${
            typeElement === 'textarea' ? 'peer-placeholder-shown:top-6' : 'peer-placeholder-shown:top-1/2'
